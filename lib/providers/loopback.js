 ...
 * @inherits {IProvider}
 */
var LoopbackProvider = exports.LoopbackProvider = function(gateway, alias, config, express){
    ...
    // Express
    var self = this;
    express.post('/receive', function(req, res){
        // Check input
        if (!req.body.body){
...
LoopbackProvider.prototype.receive = function(from, body){
    ...
    return this.gateway.receiveMessage(im);
};

/** Register a virtual subscriber which receives messages to a callback
 * @param {String} sim
 *      Subscriber phone number
 * @param {function(from:String, body:String, reply:function(body))} callback
...
LoopbackProvider.prototype.send = function(message){
    ...
    if (message.options.status_report)
        return this.gateway.receiveStatus(
            _.extend(
